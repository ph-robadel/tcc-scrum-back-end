	...
	SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		return httpSecurity.csrf(csrf -> csrf.disable())
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers(HttpMethod.POST, "/usuarios/search").authenticated()
						...
						.requestMatchers(HttpMethod.PATCH, "/usuarios/senha-admin").hasAuthority("ADMINISTRADOR")
						.requestMatchers(HttpMethod.PUT, "/usuarios/{idUsuario}").authenticated()
						...
						.requestMatchers(HttpMethod.POST, "/projetos/search").authenticated()
						.requestMatchers(HttpMethod.GET, "/projetos/{idProjeto}").authenticated()
						.requestMatchers(HttpMethod.DELETE, "/projetos/{idProjeto}").hasAnyAuthority("PRODUCT_OWNER", "SCRUM_MASTER")
						.requestMatchers(HttpMethod.POST, "/projetos/{idProjeto}/usuarios/search").authenticated()
